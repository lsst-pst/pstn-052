...
There is no free lunch. Going to higher cadence at one time demands that there be a corresponding time of lower cadence.
...
XXX--introduce the footprint object. Have some plots.
...
table with:
run, n SNe, fraction of fast micro, fraction of slow micro, max obs in season, min obs in season
