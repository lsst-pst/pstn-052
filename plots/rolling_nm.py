...
from rubin_sim.scheduler.utils import (standard_goals, NES_healpixels, Footprint,
...
def gen_greedy_surveys(nside=32, footprints=None,
    ...
    lsst.sims.scheduler.schedulers.Core_scheduler.
    To ensure we are robust against changes in the sims_scheduler codebase, all kwargs are
    explicitly set.
